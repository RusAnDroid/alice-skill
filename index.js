...
module.exports = async (req, res) => {
    ...
    let first_response_tts = 'Я могу конвертировать сумму денег в количество девяностограм+овых дошиков <[ d oo sh i k o f ]> sil <[350]> только скажите сумму и валюту sil <[350]> пока что эта функция работает только с суммами в рубл+ях sil <[120]> д+олларах и +евро sil <[150]> так как мой разработчик sil <[100]> ленивая скотина)';
    ...
    let dont_understand_tts = 'извините sil <[200]> я вас не понимаю';
            ...
            if (xhr.status == 200) {
                ...
                if (request.original_utterance == "") {
                    ...
                    if (token_pos == 0 && !usd_flag) {
                        ...
                        response_tts = 'учитывая среднестатист+ическую цену девяностограм+ового дошика <[ d oo sh i k a ]> sil <[150]> 35 рубл+ей sil <[150]> и курс д+оллара к рубл+ю по данным центрального банка российской федерации sil <[150]> один д+оллар sil <[120]> ' + usd_coef + ' ';
